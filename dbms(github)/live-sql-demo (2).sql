...
--write a query to see only ACOE AIML students
SELECT *FROM STUDENT
WHERE College = "ACOE" AND branch = 'AIML';

--write a query to see data of students
--whose age is 20
SELECT *FROM STUDENT
WHERE age =20;
--students belong to either cse or aiml
SELECT*FROM STUDENT 
WHERE  branch ='CSE'OR branch= 'AIML';
--student who pays morethan 40000
SELECT*FROM STUDENT 
WHERE  FEE>40000;
--AFTER 01-01-2020
SELECT*FROM STUDENT 
WHERE  enrollment_date >TO_DATE('01-01-2020','DD-MM-YYYY');
--SELECT THE DATA OF ALL AIML STUDENTS
--WHO JOINED BEFORE '01-01-2021'AND ARE HAVING
--AN AGE MORE THAN 25 AND PAYING ATLEAST 45000 AS FEE
SELECT *FROM STUDENT
WHERE  branch = 'AIML' 
AND enrollment_date <TO_DATE('01-01-2020','DD-MM-YYYY') 
AND AGE>30
AND FEE>=30000;
--NULLS CAN'T BE COMPARED USING EQUAL TO SYMBOL
--TO COMAPARE NULLS YOU NEED TO USE IS /ISNOT COMMANDS
SELECT *FROM STUDENT
WHERE AGE IS NOT NULL;
--
SELECT *FROM STUDENT
WHERE AGE AND EMAIL IS  NULL;