...
--BETWEEN
SELECT *FROM student where FEE BETWEEN 100000 and 130000;
...
--case
--IT IS USED TO PERFORM conditional logics on update and select
--case coloumn_name--when value1 then result1M conditional logics on update and select
--case coloumn_name--when value2 then result1
--else defaultresult
--end
--SIMPLECASE
